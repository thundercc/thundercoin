...
const QString BITCOIN_IPC_PREFIX("thundercoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click thundercoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start thundercoin: click-to-pay handler");
    else
...
{
    // clicking on thundercoin: URLs creates FileOpen events on the Mac:
