...
// Copyright (c) 2013 The Thundercoin developers
...
uint256 hashGenesisBlock("0x0000098372427dbe5d70a602231ed5fa7478cd137824be54047c1004c8591b9f");
static const unsigned int timeGenesisBlock = 1390661683;
...
static const int64 nBlockRewardStartCoin = 256 * COIN;//2048 * COIN;
static const int64 nBlockRewardMinimumCoin = 1 * COIN;

static const int64 nTargetTimespan = 10 * 60; // 10 minutes
static const int64 nTargetSpacing = 10; // 10 seconds
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "25 Jan 2014, in USA...";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 863043820;

        if (fTestNet)
        {
            block.nTime    = 1390661683;
            block.nNonce   = 123076378;
        }
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xab88e2dd541b1181c426084427ad4d61e8f662459501727c1c12b5ed1207e7f5"));
